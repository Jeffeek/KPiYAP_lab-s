...
namespace Lab_no16._3
{
	...
	{
		// путь для сохранения
		private static readonly string _filePath = $"{Directory.GetCurrentDirectory()}\\dog.xml";
		...
		// породы собак
		private static readonly string _breeds =
		...
		// типы жилья
		private static readonly string[] housingTypes = { "Бездомная", "Для дома", "Для квартиры", "Для улицы" };

		// имена хозяев
		private static readonly string _masterNames =
