...
namespace Labe_no13
{
	public class Matrix : IEquatable<Matrix>
	{
		...
		public bool Equals(Matrix other)
		{
			...
			return Equals(_innerMatrix, other._innerMatrix) && ColumnsCount == other.ColumnsCount && RowsCount == other.RowsCount;
		}
		...
		private bool IsMaxInCol(int i, int j)
		{
			...
			{
				if (this[k, j] > this[i, j]) return false;
			}
		...
		private bool IsMinInRow(int i, int j)
		{
			...
			{
				if (this[i, k] < this[i, j]) return false;
			}
