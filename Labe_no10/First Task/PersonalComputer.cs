...
namespace Labe_no10.First_Task
{
    public class PersonalComputer
    {
        ...
        public virtual double CalculatePrice() =>
            ClockSpeed * CoresCount / 100.0 + RAM / 80.0 + HardDriveCapacity / 20.0;

        public virtual bool IsSuitable() =>
            ClockSpeed >= 2000 && CoresCount >= 2 && RAM >= 2048 && HardDriveCapacity >= 320;

        public override string ToString() =>
            $"{nameof(ClockSpeed)}: {ClockSpeed} Mhz,"
